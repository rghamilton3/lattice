...
export function parseSignalMessage(
	...
	const attachments = (payload.attachments as SignalAttachment[] | null | undefined) ?? [];
	...
	const payloadTimestamp = typeof payload.timestamp === 'number' ? payload.timestamp : undefined;
