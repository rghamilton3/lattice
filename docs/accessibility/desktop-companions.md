...
- Canceling the folder picker leaves the visible path unchanged. Picker launch failure or known unsupported display environments show plain text guidance to type the watch path manually and try saving again.
